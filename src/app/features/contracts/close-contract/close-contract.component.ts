...
@Component({
  ...
  template: `
    <div class="breadcrumb">
      ...
      <span class="current">Cierre de Contrato</span>
    </div>
    <div class="placeholder-card">
      <span class="material-icons placeholder-icon">lock</span>
      <div class="placeholder-text">Cierre de contrato — próximamente</div>
    </div>
  `,
  styles: [`
    .breadcrumb {
...
export class CloseContractComponent {}
